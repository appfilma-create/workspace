...
import { User, Plus, Search, Shield, Folder } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm mt-1">
                    Gestión de usuarios y permisos de contabilidad
                  </p>
                </div>
              </div>
              <button className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium transition-colors shadow-md">
                <Plus size={16} />
                Añadir usuario
              </button>
            </div>
          ...
          <div className="bg-slate-50 border-2 border-dashed border-slate-300 rounded-2xl p-12 text-center">
            ...
            <p className="text-slate-600 mb-4">
              Gestiona los usuarios con acceso al módulo de contabilidad
            </p>
            <div className="text-xs text-slate-500 bg-white rounded-lg p-4 inline-block">
              <p className="font-mono">
                app/project/[id]/accounting/usuarios/page.tsx
              </p>
            </div>
          </div>
        </div>
